...
<div class="col-sm-6">
<input type="text" name="username" placeholder="Usuario" autofocus  required  class="form-control">
<span class="form-text text-danger"> ${error_txt} </span>
</div>
</div>
...
<input type="password" name="password" placeholder="Contraseña"  required class="form-control pwd ${danger != null ? 'alert-danger' : ''}">
...
<div class="col-sm-6">
<input type="submit" value="Identificarse" class="btn btn-primary"/>
<sec:csrfInput />  
