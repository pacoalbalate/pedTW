					...
					<tbody>
						<c:forEach var="reg" items="${pagina.page.toList()}">
							...
							<tr>
								...
								<td><fmt:formatDate type = "date" value="${reg.fecha}" pattern="yyyy-MM-dd"/></td>
								<td><c:out value="${reg.tipoprueba.opcion}"></c:out></td>
								<td class="text-right"><fmt:formatNumber type = "number" value="${reg.totalpruebas}" /></td>
								<td>
